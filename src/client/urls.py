from .views import create_client, edit_client, list_clients, individual_report, generate_client_id
...
urlpatterns = [
    ...
    path('generate-client-id/', generate_client_id, name='generate_client_id')
]
