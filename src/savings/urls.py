...
from .views import daily_contribution_report, multi_day_contribution_view, fetch_contributions, group_combined_payment
from .views import daily_contribution_spreadsheet, daily_contribution_spreadsheet_form, get_group_clients
...
urlpatterns = [
    ...
    path('group-combined-payment/', group_combined_payment, name='group_combined_payment'),
    path('get-group-clients/<int:group_id>/', get_group_clients, name='get_group_clients'),
]