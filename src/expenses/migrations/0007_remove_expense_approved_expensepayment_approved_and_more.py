...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('expenses', '0006_expense_approved'),
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='expensepayment',
            name='created_by',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='expense_payments', to=settings.AUTH_USER_MODEL),
        ),
        migrations.AddField(
            model_name='expensepayment',
            name='transaction',
